...
class EnhancedCityVisualizer {
  ...
  getApproximateCoordinates(city, state) {
    ...
    const cityCoordinates = {
      ...
      // Additional cities from warnings
      'Kure Beach,NC': { lat: 34.1975, lng: -77.9191 },
      'Forest City,NC': { lat: 35.3394, lng: -81.8592 },
      'Waynesville,NC': { lat: 35.4922, lng: -82.9929 },
      'Mills River,NC': { lat: 35.3817, lng: -82.6050 },
      'Flat Rock,NC': { lat: 35.3642, lng: -82.6333 },
      'Swannanoa,NC': { lat: 35.6225, lng: -82.4467 },
      'Black Mountain,NC': { lat: 35.6200, lng: -82.3233 },
      'Brevard,NC': { lat: 35.2348, lng: -82.7363 },
      'East Flat Rock,NC': { lat: 35.3500, lng: -82.6500 },
      'Pineville,NC': { lat: 35.2050, lng: -80.8661 },
      'Columbus,NC': { lat: 35.3022, lng: -82.5869 },
      'Fletcher,NC': { lat: 35.3867, lng: -82.6917 },
      'Smithfield,NC': { lat: 35.5067, lng: -78.3839 },
      'Arden,NC': { lat: 35.3842, lng: -82.7008 },
      'Burnsville,NC': { lat: 35.8975, lng: -82.2625 },
      'Zirconia,NC': { lat: 35.2750, lng: -82.7917 },
      'Dillsboro,NC': { lat: 35.3639, lng: -83.2425 },
      'Hartwell,GA': { lat: 34.3519, lng: -82.9294 },
      'Cleveland,GA': { lat: 34.5994, lng: -84.0033 },
      'Andrews,NC': { lat: 35.0475, lng: -83.8600 },
      'Blue Ridge,GA': { lat: 34.5033, lng: -84.2989 },
      'Stearns,KY': { lat: 36.6711, lng: -84.3433 },
      'Hillsborough,NC': { lat: 36.0725, lng: -79.2000 },
      'Townsend,TN': { lat: 35.6167, lng: -83.5167 },
      'Baxter,TN': { lat: 35.5833, lng: -85.4167 },
      'Mascot,TN': { lat: 35.7833, lng: -83.5500 },
      'Mount Cammerer,TN': { lat: 35.7500, lng: -82.9833 },
      'Greenback,TN': { lat: 35.5000, lng: -84.4167 },
      'Roan Mountain,TN': { lat: 36.1833, lng: -82.1167 },
      'Vonore,TN': { lat: 35.4333, lng: -84.2500 },
      'Minneapolis,MN': { lat: 44.9778, lng: -93.2650 },
      'Woodfin,NC': { lat: 35.6558, lng: -82.5350 },
      'Weaverville,NC': { lat: 35.6561, lng: -82.5583 },
      'Etowah,NC': { lat: 35.2842, lng: -82.9250 },
      'Horse Shoe,NC': { lat: 35.2667, lng: -82.8667 },
      'Rutherfordton,NC': { lat: 35.3883, lng: -81.9533 },
      'Tryon,NC': { lat: 35.2214, lng: -82.2289 },
      'Mill Spring,NC': { lat: 35.2917, lng: -82.2667 },
      'Landrum,SC': { lat: 35.2903, lng: -82.2281 },
      'Campobello,SC': { lat: 35.2233, lng: -82.0672 },
      'Greer,SC': { lat: 34.9733, lng: -82.2103 },
      'Inman,SC': { lat: 35.1017, lng: -82.1203 },
      'Taylors,SC': { lat: 34.9167, lng: -82.3500 },
      'Drayton,SC': { lat: 34.7833, lng: -82.6333 },
      'Moore,SC': { lat: 35.0833, lng: -82.3667 },
      'Simpsonville,SC': { lat: 34.7428, lng: -82.2686 },
      'Easley,SC': { lat: 34.6033, lng: -82.5464 },
    ...
    // Default to Hendersonville, NC but only warn once per city/state to avoid noisy logs.
    ...
    modal.innerHTML = `
      ...
      <div class="enhanced-city-controls">
        ...
        <div class="city-tag-filter-section">
          ...
          <input type="text" class="city-tag-search-input" id="cityTagSearchInput" placeholder="Search and add tags..." style="width: 100%; padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px;">
