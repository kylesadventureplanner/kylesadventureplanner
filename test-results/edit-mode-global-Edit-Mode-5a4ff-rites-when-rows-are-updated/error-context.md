...
- Name: edit-mode-global.spec.js >> Edit Mode – target-table selectors >> automation handlers persist workbook writes when rows are updated
- Location: tests/edit-mode-global.spec.js:965:3

# Error details

```
Error: page.evaluate: ReferenceError: overwrite is not defined
    at window.handlePopulateMissingFields (http://127.0.0.1:4321/JS%20Files/consolidated-bulk-operations-system-v7-0-141.js:2292:61)
    at async eval (eval at evaluate (:302:30), <anonymous>:4:38)
    at async <anonymous>:328:30
```

```
Error: Unexpected browser errors detected:
1. [console] ❌ Error processing Playwright Mountain Trail Cafe: ReferenceError: Cannot access 'diag' before initialization
    at window.handlePopulateMissingFields (http://127.0.0.1:4321/JS%20Files/consolidated-bulk-operations-system-v7-0-141.js:2070:13)
    at async eval (eval at evaluate (:302:30), <anonymous>:4:38)
    at async <anonymous>:328:30 (http://127.0.0.1:4321/JS%20Files/consolidated-bulk-operations-system-v7-0-141.js)
2. [console] ❌ Error updating descriptions: ReferenceError: Cannot access 'diag' before initialization
    at window.handlePopulateMissingFields (http://127.0.0.1:4321/JS%20Files/consolidated-bulk-operations-system-v7-0-141.js:2117:9)
    at async eval (eval at evaluate (:302:30), <anonymous>:4:38)
    at async <anonymous>:328:30 (http://127.0.0.1:4321/JS%20Files/consolidated-bulk-operations-system-v7-0-141.js)
```
...
- generic [ref=e1]:
  ...
  - generic [ref=e105]:
    - strong [ref=e106]: "❌ Error:"
    - text: Cannot access 'diag' before initialization
```