...
- Name: nature-sync-routing.spec.js >> Nature sync routing — Graph table-name assertions >> insects and trees route to distinct table names even when sharing the same workbook
- Location: tests/nature-sync-routing.spec.js:375:3

# Error details

```
Error: insects must POST to Insects_sightings
...
- generic [ref=e1]:
  ...
  - generic "Click to expand/collapse" [ref=e10] [cursor=pointer]:
    - generic [ref=e11]:
      ...
      - generic [ref=e12]: "Startup timing: interactive 95 ms | overlay off 446 ms"
            ...
            - generic [ref=e78]:
              - generic [ref=e79]:
                ...
                - generic [ref=e82]:
                  ...
                  - generic [ref=e84]: "0 species | Source: Excel table 'birds' in Copilot_Apps/Kyles_Adventure_Finder/Nature_records.xlsx Updated 4/21/2026, 5:57:08 PM"
              - generic [ref=e85]:
