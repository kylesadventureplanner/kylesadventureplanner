...
- Name: edit-mode-global.spec.js >> Edit Mode – target-table selectors >> update hours normalizes stringified JSON payloads before persisting
- Location: tests/edit-mode-global.spec.js:1110:3

# Error details

```
Error: page.evaluate: TypeError: window.handleUpdateHoursOnly is not a function
    at eval (eval at evaluate (:302:30), <anonymous>:4:47)
