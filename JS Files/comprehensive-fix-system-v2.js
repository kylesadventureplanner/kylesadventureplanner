...
(function() {
  ...
  // ============================================================
  // 2. PAGINATION FIX - Next/Previous buttons
  // ============================================================
  ...
  // ============================================================
  // 3. DRY RUN SLIDER FIX - Make sliders actually work
  // ============================================================
    ...
    dryRunIds.forEach(id => {
      ...
      if (checkbox) {
        ...
        checkbox.addEventListener('change', function(e) {
          ...
          const feature = id.replace('DryRun', '');
          const baseId = feature.charAt(0).toUpperCase() + feature.slice(1);
  ...
  // ============================================================
  // 4. REFRESH PLACE IDS - WITH REAL PROGRESS TRACKING
  // ============================================================
  ...
  if (!window.applyFiltersFixed) {
    ...
    window.applyFilters = function() {
      ...
      if (!window.totalFilteredAdventures || !Array.isArray(window.totalFilteredAdventures)) {
        window.totalFilteredAdventures = window.adventuresData ? [...window.adventuresData] : [];
        console.log('✅ Initialized totalFilteredAdventures with', window.totalFilteredAdventures.length, 'items');
      }
